  ...
  return (
    <View style={styles.header}>
      ...
      <View style={styles.headerTitleContainer}>
        ...
        <Text style={styles.headerTitle}>Busca por <Text style={styles.headerTitleBlue}>Placa</Text></Text>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  header: { paddingHorizontal: 20, flexDirection: 'row', marginBottom: 30 },
